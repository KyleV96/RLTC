...
class Simulation:
    def __init__(self, Model, Memory, TrafficGen, sumo_cmd, gamma, max_steps, green_duration, adv_green_duration, yellow_duration, red_duration, num_states, num_actions, training_epochs):
        self._Model = Model
        self._Memory = Memory
        ...
        self._adv_green_duration = adv_green_duration
    ...
    def run(self, episode, epsilon):
        ...
        while self._step < self._max_steps:
            ...
            if action == 0 or action == 2:
                ...
                self._set_green_phase(action)
                self._simulate(self._adv_green_duration)
        ...
        print(f"Total Phase Changes {self._total_phases}, Sequential Phases: {self._sequential_phases}")
