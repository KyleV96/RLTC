...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            print("""<routes>
            <vType accel="1.0" decel="4.5" id="standard_car" length="5.0" minGap="2.5" maxSpeed="20" sigma="0.5" />
            <route id="W_N" edges="W2TL2 W2TL1 W2TL TL2N"/>
            <route id="W_E" edges="W2TL2 W2TL1 W2TL TL2E"/>
            <route id="W_S" edges="W2TL2 W2TL1 W2S TL2S1"/>
            <route id="N_W" edges="N2TL2 N2TL1 N2W TL2W1 TL2W2"/>
            <route id="N_E" edges="N2TL2 N2TL1 N2TL TL2E"/>
            <route id="N_S" edges="N2TL2 N2TL1 N2TL TL2S TL2S1"/>
            <route id="E_W" edges="E2TL1 E2TL TL2W TL2W1 TL2W2"/>
            <route id="E_N" edges="E2TL1 E2TL TL2N"/>
            <route id="E_S" edges="E2TL1 E2TL TL2S"/>
            <route id="S_W" edges="S2TL1 S2TL TL2W TL2W1 TL2W2"/>
            <route id="S_N" edges="S2TL1 S2TL TL2N"/>
            <route id="S_E" edges="S2TL1 S2TL TL2E"/>""", file=routes)
